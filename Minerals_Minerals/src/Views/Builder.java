...
public class Builder extends java.awt.Dialog
{
    ...
    private void initComponents()
    {
        ...
        jLabel7.setText("Recolección:");

        collect.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        collect.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        collect.setText("0");
    ...
    {//GEN-HEADEREND:event_btnCreateActionPerformed
        ...
        if (!this.minersCapability.getText().equals("") && !this.timeEx.getText().equals(""))
        {
            ...
            this.mine.setCollectQuantity(Double.parseDouble(this.collect.getText()));
